 ...
 * Last updated: 2025-09-05T21:10:10.910Z
 */
...
export const neighborhood = {
  ...
  city: "Toronto",
  description: "Waterfront Communities places you at the heart of Toronto’s Entertainment District, offering an immersive, cosmopolitan lifestyle rich with dining, nightlife and cultural destinations. Residents enjoy world-class theatres, a dense restaurant scene along King West, easy access to the waterfront and abundant green space for outdoor recreation.",
  highlights: [
    "Proximity to iconic attractions including CN Tower, Rogers Centre, Ripley's Aquarium, and Scotiabank Arena",
    "Location in Toronto's vibrant Entertainment District with acclaimed theatres and diverse restaurants on King Street West",
    "Access to Harbourfront outdoor activities and the Martin Goodman Trail for walking, running and cycling",
    "Convenient transit options including access to the PATH system, Union Station and frequent streetcar service",
    "A vibrant arts and nightlife scene with boutique shops, galleries and more than 40 cafés within walking distance"
  ]
};
...
export const neighborhoodAmenities = [
  ...
  {
    id: 6,
    name: "King St West at Peter St (bus stop)",
    distance: "",
  ...
  {
    id: 8,
    name: "GO Transit North Bathurst Yard",
    distance: "",
    category: "business",
    iconName: "Wifi"
  }
...
export const property = {
  ...
  heroCaption: "Floor-to-Ceiling Windows + Renovated Kitchen + Parking = Your Perfect Condo Just Listed!"
};
...
export const siteMetadata = {
  ...
  description: "Floor-to-Ceiling Windows + Renovated Kitchen + Parking = Your Perfect Condo Just Listed!",
